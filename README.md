...
data_sample_2 -> data_sample_new
data_sample_new=data_sample_2[!data_sample_2$mindfulness<=1,]


pred_test <- predict(mod_pain3_cortisolsaliva_out, data_sample_new)
pred_test_back <- predict(mod_back_pain_best, data_sample_new)

RSS_test = sum((data_sample_new["pain"] - pred_test)^2)
RSS_test_back = sum((data_sample_new["pain"] - pred_test_back)^2)
RSS_test
RSS_test_back
